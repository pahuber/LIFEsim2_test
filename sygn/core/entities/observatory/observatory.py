...
from sygn.core.entities.observatory.array_configurations import ArrayConfigurationEnum
from sygn.core.entities.observatory.beam_combination_schemes import BeamCombinationSchemeEnum
