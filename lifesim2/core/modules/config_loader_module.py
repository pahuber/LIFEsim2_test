...
from lifesim2.core.entities.mission import Mission
from lifesim2.core.entities.observatory.array_configurations import ArrayConfiguration, ArrayConfigurationEnum, \
    EmmaXCircularRotation, EmmaXDoubleStretch, EquilateralTriangleCircularRotation, RegularPentagonCircularRotation
from lifesim2.core.entities.observatory.beam_combination_schemes import BeamCombinationScheme, DoubleBracewell, Kernel3, \
    Kernel4, Kernel5, BeamCombinationSchemeEnum
from lifesim2.core.entities.observatory.instrument_parameters import InstrumentParameters
from lifesim2.core.entities.observatory.observatory import Observatory
from lifesim2.core.entities.settings import Settings
...
class ConfigLoaderModule(BaseModule):
    ...
    def _load_settings(self, config_dict: dict) -> Settings:
        ...
        return Settings(**config_dict['settings'],
                        integration_time=self.mission.integration_time,
                        number_of_inputs=self.observatory.beam_combination_scheme.number_of_inputs)
