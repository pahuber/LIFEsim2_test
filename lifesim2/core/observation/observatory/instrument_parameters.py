...
class InstrumentParameters():
    def __init__(self,
        ...
        self.spectral_range_lower_limit = spectral_range_lower_limit.to(u.um)
        self.spectral_range_upper_limit = spectral_range_upper_limit.to(u.um)
    ...
    def _get_wavelength_bins(self):
        ...
        :return:
        """
        minimum_bin_width = self.spectral_range_lower_limit.value / self.spectral_resolving_power.value
        maximum_bin_width = self.spectral_range_upper_limit.value / self.spectral_resolving_power.value
        wavelength = self.spectral_range_lower_limit.value

        number_of_wavelengths = 1

        while (wavelength < self.spectral_range_upper_limit.value + maximum_bin_width):
        ...
        wavelengths[0] = self.spectral_range_lower_limit.value
