...
plt.plot(photon_rate_time_series_total, label=f'Total')
plt.plot(simulation.output.get_photon_rate_time_series_for_source('Earth', 10 * u.um)[0], label=f'Earth 10 um')
